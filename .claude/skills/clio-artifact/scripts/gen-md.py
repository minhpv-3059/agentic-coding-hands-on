#!/usr/bin/env python3
"""gen-md: emit a project_content_{id}_{ts}.md from JSON input.
...
and writes a domain-organized markdown profile to:
  {output_dir}/project_content_{project_id}_{timestamp}.md
...
def main():
    ...
    out_file = out_dir / f'project_content_{args.project_id}_{timestamp}.md'
