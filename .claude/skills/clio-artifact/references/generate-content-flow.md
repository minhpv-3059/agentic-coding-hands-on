...
```json
{
  ...
  "input_text": "業務フロー 業務プロセス 業務の流れ 主要業務 担当部署 作業手順 業務概要"
}
```
...
{
  "project_id": "<project_id>",
  "input_text": "システム概要 導入背景 対象業務 利用部門 ユーザー"
}
```
...
{
  "project_id": "<project_id>",
  "input_text": "現行業務 手作業 現行システム 課題 非効率 手動 二重入力 確認作業 既存の問題点 ボトルネック"
}
```
...
{
  "project_id": "<project_id>",
  "input_text": "システム導入後 業務改善 自動化 効率化 新機能 改善効果 簡素化 デジタル化"
}
```
