...
- `--template "[SVN] Proposal Menu.pptx"` — name auto-resolves under `clio-artifact/templates/`
...
| Template not found | Verify `[SVN] Proposal Menu.pptx` exists under `claude/skills/clio-artifact/templates/` |
