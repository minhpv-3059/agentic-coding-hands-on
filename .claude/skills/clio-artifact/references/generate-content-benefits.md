...
```
{
  ...
  "input_text": "業務プロセス改善 ビジネスプロセス変更 デジタルトランスフォーメーション 業務効率化 自動化 ワークフロー簡素化 コスト削減 生産性向上 品質改善 エラー削減 手作業削減 業務標準化"
}
```
...
{
  "project_id": "<project_id>",
  "input_text": "現行の手作業 業務改善効果 システム導入効果 業務フロー改善 作業時間短縮 人的コスト削減 ミス削減効果"
}
```
