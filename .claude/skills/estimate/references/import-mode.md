...
- **Excel/CSV with WBS structure**: Run `python3 skills/agentic-estimate/scripts/parse-document.py <file> --cache`
- **PDF/DOCX/PPTX/images**: Run `python3 skills/agentic-estimate/scripts/parse-document.py <file> --cache`
- **Markdown/text**: Read directly with Read tool.
- **URLs**: Run `python3 skills/agentic-estimate/scripts/parse-document.py <url>`
