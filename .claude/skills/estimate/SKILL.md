...
description: >
  ...
  'calibration', 'tune knowledge base', 'estimate', 'task-breakdown'.
  Also activate when user wants to generate Sun* project artifacts (project-profile,
  user-story, screen-flow, function-list, estimate) from Clio KG data.
