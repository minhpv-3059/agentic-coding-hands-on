...
Usage:
    python skills/agentic-estimate/scripts/validate-estimate.py estimate.json
    python skills/agentic-estimate/scripts/validate-estimate.py estimate.json --strict
"""
