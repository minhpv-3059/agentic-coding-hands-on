...
| Symbol | Path | Purpose |
|--------|------|---------|
| LoginForm | `claude/skills/rebuild-spec/scripts/tests/fixtures/cited-source.py:5-10` | Credential validation logic |

JSX ternary present in source (triggers lazy-N/A warning — Decision Logic is N/A but spec contains conditional patterns):
