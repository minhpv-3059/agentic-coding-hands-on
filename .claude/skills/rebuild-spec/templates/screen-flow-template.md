...
{Populated by W6 researchers AFTER feature-list.md exists. W2 ScreenFlow researcher leaves this section as the placeholder below — do NOT populate it during W2.}

{POPULATED_BY_W6}

{W6 researcher pattern: each W6 researcher emits a fragment file `plans/<active>/artifacts/_feature-entry-points/F###.md` (one file per feature, no write contention). After all W6 tasks complete, the orchestrator consolidates all fragment files into this section.}
